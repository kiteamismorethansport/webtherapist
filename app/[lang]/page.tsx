    ...
    <main>
      <section className="bg-gradient-to-b from-zinc-50 to-white border-b">
        <div className="mx-auto max-w-6xl px-4 py-24 grid md:grid-cols-2 gap-10 items-center">
          ...
          <div className="aspect-video rounded-2xl bg-[url('/images/placeholder-hero.jpg')] bg-cover bg-center shadow-md" aria-label="Therapy office" />
        </div>
      </section>

      <section id="about" className="scroll-mt-24">
        <div className="mx-auto max-w-6xl px-4 py-16">
          <h2 className="text-2xl md:text-3xl font-semibold mb-6">{settings.nav.workWithMe}</h2>
          <article className="prose max-w-none">
            {/* MDX content could render here */}
          </article>
        </div>
      </section>
    </main>
